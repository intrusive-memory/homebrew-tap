class Diga < Formula
  ...
  url "https://github.com/intrusive-memory/SwiftVoxAlta/releases/download/v0.9.8/diga-0.9.8-arm64-macos.tar.gz"
  sha256 "79d219ed9d14aa6f2be438cc42f9a17127a494723a481bd316255ebdad70e5e1"
  license "MIT"
  version "0.9.8"
