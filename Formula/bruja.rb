class Bruja < Formula
  ...
  url "https://github.com/intrusive-memory/SwiftBruja/releases/download/v1.8.1/bruja-1.8.1-arm64-macos.tar.gz"
  sha256 "f53aca13312901c5e2e91dde4fe5e0ba2dd584fa2e0bc36070418b45186f5b75"
  license "MIT"
  version "1.8.1"
